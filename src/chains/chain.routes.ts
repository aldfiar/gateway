...
import {Chain, TransferRequest, TransferResponse,} from '../services/common-interfaces';
import {ConfigManagerV2} from '../services/config-manager-v2';
import {asyncHandler} from '../services/error-handler';
import {mkRequestValidator, RequestValidator, validateTxHash,} from '../services/validators';
import {
...
import {allowances, approve, balances, cancel, getTokens, nextNonce, nonce, poll,} from './chain.controller';
...
export namespace ChainRoutes {
  ...
  router.post(
    ...
    asyncHandler(
      async (
        _req: Request<{}, {}, TransferRequest>,
        res: Response<TransferResponse, {}>,
      ) => {
        res.status(200).json('not imlpelemented');
      },
    ),
  );
}
